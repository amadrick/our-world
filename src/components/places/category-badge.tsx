import { Camera, Coffee, Compass, ShoppingBag } from "react-feather";

import { Bread, Cocktail, IceCream, Museum, Utensils, WineGlass } from "@/components/icons/feather-extras";
